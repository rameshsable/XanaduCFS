...
public interface FeedbackService {
	...
	public List<Feedback> getfeedBackOpenIssueDateCriteriaReport(FeedBackTypeTable feedbackType,
	...
	public List<FeedBackSonumberSortingByDate> getSortedFeedBackListAccordingtToFeedbackId(FeedBackTypeTable typeTable, HttpServletRequest request);
	...
	String saveChattingFeedComForWebService(String soNumber, String status, String subject, String Attachment,
	...
	List<FeedBackCounterForHome> getfeedBackCounterForHomeByDate(List<FeedBackTypeTable> feedBackTypeTables,
