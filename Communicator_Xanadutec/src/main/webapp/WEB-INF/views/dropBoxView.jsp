...
<jsp:include page="menu.jsp"></jsp:include>
 ...
 <div id="container-fluid" >
       ...
       <br>
        <div class="span2">
              <h1 class="page-header">Drop Box Details </h1>
             	 ...
             	 <div class="table-responsive">  <!-- dropBoxlist -->
                                        ...
                                        <table class="table table-bordered table-hover table-striped" id="dataTable1"  >
											...
											<c:forEach var="feedcount" items="${dropBoxLIst}" varStatus="theCount">
												...
												<c:forEach var="feedcount1" items="${filename1}" varStatus="theCount">
												 <tr >
					  										...
					  										<c:set var="length" value="	${fn:length(msg)}"/>
					  										 ...
					  										 <td><a href="<c:url value="reportDownload"><c:param name="path" value="${feedcount1}"/> </c:url>"><strong ><input type="button" value="Download" class="btn btn-primary"> </strong> </a>
		                            						</td>
